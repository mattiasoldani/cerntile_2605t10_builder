...
def main(argv):
    ...
    try:
        ...
        while True:
            ...
            if channel in previous_trigger_by_channel:
                difference = trigger_timestamp - previous_trigger_by_channel[channel]
                if difference < 0 :
                ...
                event['timestamp_difference'] = trigger_timestamp - previous_trigger_by_channel[channel]
            else:
                event['timestamp_difference'] = NAN
            previous_trigger_by_channel[channel] = trigger_timestamp
